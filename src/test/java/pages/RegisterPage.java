...
public class RegisterPage extends BasePage {
  ...
  private By alertAddtionalInformationLocator = By.xpath("/html/body/div[1]/div[2]/div[3]/div/div/form/div[2]/p[11]");
  ...
  public String getEmailNewAccount() {
    super.waitVisibilityOfElementLocated(alertAddtionalInformationLocator);
  ...
  public void fillOutForm() {
    ...
    if (super.isDisplayed(genderFemaleLocator)) {
      ...
      super.type("Canila", customerFirstNameLocator);
